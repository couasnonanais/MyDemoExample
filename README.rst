...
This is an example during SURF day training
...
To install repo_project, do:

.. code-block:: console

  git clone https://github.com/couasnonanais/repo_project.git
  cd repo_project
  pip install .
...
If you want to contribute to the development of SURFexample,
